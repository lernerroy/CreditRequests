sap.ui.define(
  ...
  function (BaseObject, Sorter) {
    ...
    return BaseObject.extend("IAI.zcns_mng_crd12.model.GroupSortState", {
      /**
       ...
       * @alias IAI.zcns_mng_crd12.model.GroupSortState
       */
      ...
      /**
       * Groups by Preis, or resets the grouping for the key "None"
       *
       * @param {string} sKey - the key of the field used for grouping
       * @returns {sap.ui.model.Sorter[]} an array of sorters
       */
      group: function (sKey) {
        ...
        if (sKey === "Preis") {
          ...
          this._oViewModel.setProperty("/sortBy", "Preis");

          aSorters.push(
            new Sorter("Preis", false, this._fnGroupFunction.bind(this))
          );
        } else if (sKey === "None") {
          // select the default sorting again
          this._oViewModel.setProperty("/sortBy", "Banfn");
        }
