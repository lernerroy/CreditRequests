		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#IAIzcnsmngcrd12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IAIzcnsmngcrd12-display": {
								"semanticObject": "IAIzcnsmngcrd12",
								"action": "display",
								"description": "Manage Credit Requests",
								"title": "Manage Credit Requests",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=IAI.zcnsmngcrd12",
									"url": sap.ui.require.toUrl("IAI/zcnsmngcrd12")
								}
							}
						}
					}
