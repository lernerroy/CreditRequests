...
sap.ui.define(
  [
    ...
    "IAI/zcns_mng_crd12/model/grouper",
    "IAI/zcns_mng_crd12/model/GroupSortState"
  ],
  function (
    BaseController,
    JSONModel,
    ...
    return BaseController.extend("IAI.zcns_mng_crd12.controller.Master", {
      formatter: formatter,
      ...
      onInit: function () {
        ...
        this.getRouter().attachRoutePatternMatched(function(oEvent){
            ...
            this.getModel("masterView").setProperty("/createEnabled", routeName === "newCreditRequest" ? false : true);
        }, this);
      },

      onNewCreditRequestPressed: function () {
        this.getRouter().navTo("newCreditRequest", null, true);
      },
      ...
      onSearch: function (oEvent) {
        ...
        if (sQuery) {
          this._oListFilterState.aSearch = [
            new Filter("Banfn", FilterOperator.Contains, sQuery),
          ];
        } else {
          this._oListFilterState.aSearch = [];
        }
      ...
      onOpenViewSettings: function () {
        if (!this._oViewSettingsDialog) {
          this._oViewSettingsDialog = sap.ui.xmlfragment(
            "IAI.zcns_mng_crd12.view.ViewSettingsDialog",
            this
          );
      ...
      onConfirmViewSettingsDialog: function (oEvent) {
        ...
        aFilterItems.forEach(function (oItem) {
          switch (oItem.getKey()) {
            case "Filter1":
              aFilters.push(new Filter("Preis", FilterOperator.LE, 100));

              break;

            case "Filter2":
              aFilters.push(new Filter("Preis", FilterOperator.GT, 100));
